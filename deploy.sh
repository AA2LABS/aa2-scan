...
echo "Step 1: Removing corrupt image files..."
rm -f "$PROJECT/assets/images/tab-produce.png"
rm -f "$PROJECT/assets/images/tab-meat.png"
rm -f "$PROJECT/assets/images/tab-care.png"
rm -f "$PROJECT/assets/images/tab-grownfolks.png"
rm -f "$PROJECT/assets/images/tab-k9.png"
rm -f "$PROJECT/assets/images/tab-agri.png"
rm -f "$PROJECT/assets/images/tab-horse.jpg"
echo "✅ Corrupt images deleted"

echo "Step 2: Writing clean index.tsx..."
cat > "/Users/jamespitts/Downloads/aa2-scan/app/(tabs)/index.tsx" << 'FILEOF'
...
FILEOF
echo "✅ index.tsx written"

echo "Step 3: Bundle test..."
cd "$PROJECT"
npx expo export --platform android 2>&1 | tail -3

echo "Step 4: Commit and build..."
git add -A
git commit -m "Canon v26: clean build — corrupt images removed, heroes nulled"
